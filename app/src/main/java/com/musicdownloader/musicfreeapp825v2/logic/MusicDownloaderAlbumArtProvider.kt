 ...
 *
 * URI format: `content://com.musicdownloader.musicfreeapp825v2.albumart/{type}/{id}`
 * where `type` is "song" or "album" and `id` is a song ID.
 */
class MusicDownloaderAlbumArtProvider : ContentProvider() {
    ...
    companion object {
        ...
        /**
         * Builds a `content://` URI pointing to [MusicDownloaderAlbumArtProvider].
         *
