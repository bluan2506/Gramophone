...
package com.musicdownloader.musicfreeapp825v2.logic.ui
...
import com.musicdownloader.musicfreeapp825v2.logic.utils.exoplayer.oem.xiaomi.IsLandHelp
    ...
    override fun addNotificationActions(
        ...
        if (ticker != null) {
            builder.addExtras(Bundle().apply {
                putInt("ticker_icon", R.drawable.ic_music_downloader_mono16)
