...
import com.musicdownloader.musicfreeapp825v2.logic.utils.AfFormatTracker
import com.musicdownloader.musicfreeapp825v2.logic.utils.AudioTrackInfo
import com.musicdownloader.musicfreeapp825v2.logic.utils.BtCodecInfo
import com.musicdownloader.musicfreeapp825v2.logic.utils.CircularShuffleOrder
import com.musicdownloader.musicfreeapp825v2.logic.utils.Flags
import com.musicdownloader.musicfreeapp825v2.logic.utils.LastPlayedManager
import com.musicdownloader.musicfreeapp825v2.logic.utils.LrcUtils.LrcParserOptions
import com.musicdownloader.musicfreeapp825v2.logic.utils.LrcUtils.extractAndParseLyrics
import com.musicdownloader.musicfreeapp825v2.logic.utils.LrcUtils.loadAndParseLyricsFile
import com.musicdownloader.musicfreeapp825v2.logic.utils.MediaItemList
import com.musicdownloader.musicfreeapp825v2.logic.utils.ReplayGainAudioProcessor
import com.musicdownloader.musicfreeapp825v2.logic.utils.ReplayGainUtil
import com.musicdownloader.musicfreeapp825v2.logic.utils.SemanticLyrics
...
/**
 * [MusicDownloaderPlaybackService] is a server service.
 * It's using exoplayer2 as its player backend.
 */
class MusicDownloaderPlaybackService : MediaLibraryService(), MediaSessionService.Listener,
    ...
    companion object {
        ...
        var instanceForWidgetAndLyricsOnly: MusicDownloaderPlaybackService? = null
    }
        ...
        mediaSession =
            MediaLibrarySession
                ...
                .setBitmapLoader(CacheBitmapLoader(object : BitmapLoader {
                    ...
                    private val limit by lazy { MediaSession.getBitmapDimensionLimit(this@MusicDownloaderPlaybackService) }
                    ...
                    override fun decodeBitmap(data: ByteArray): ListenableFuture<Bitmap> {
                        return CallbackToFutureAdapter.getFuture { completer ->
                            imageLoader.enqueue(
                                ImageRequest.Builder(this@MusicDownloaderPlaybackService)
                                    .data(data)
    ...
    override fun onSetRating(
        ...
        lifecycleScope.launch(Dispatchers.Default) {
            ...
            val token = if (uriIn != null) {
                MediaStoreCompat.needRequestBytesWrite(this@MusicDownloaderPlaybackService,
                    uriIn)
            } else {
                MediaStoreCompat.needRequestCreate(this@MusicDownloaderPlaybackService,
            ...
            if (token == null) {
                try {
                    ...
                    ItemManipulator.setPlaylistContent(this@MusicDownloaderPlaybackService, uri,
            ...
            if (token == null && error == null) {
                ...
                if (!supportsNotificationPermission() || hasNotificationPermission()) {
                    ...
                    nm.notify(FAVE_ID, NotificationCompat.Builder(
                        this@MusicDownloaderPlaybackService, NOTIFY_CHANNEL_ID).apply {
                        setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
                        setAutoCancel(true)
                        setCategory(NotificationCompat.CATEGORY_ERROR)
                        setSmallIcon(R.drawable.ic_error)
                        setContentTitle(this@MusicDownloaderPlaybackService.getString(R.string.favorite_failed_title))
                        setContentText(this@MusicDownloaderPlaybackService.getString(R.string.favorite_failed_text))
                        setContentIntent(
                            PendingIntent.getActivity(
                                this@MusicDownloaderPlaybackService,
                                PENDING_INTENT_FAVE_ID,
                                Intent(this@MusicDownloaderPlaybackService, MainActivity::class.java)
    ...
    override fun onMediaItemTransition(mediaItem: MediaItem?, reason: Int) {
        if (reason != Player.MEDIA_ITEM_TRANSITION_REASON_REPEAT) {
            ...
            bitrateFetcher.launch {
                bitrate = mediaItem?.getBitrate(this@MusicDownloaderPlaybackService) // TODO subtract cover size
                this@MusicDownloaderPlaybackService.mediaSession?.broadcastCustomCommand(
                    SessionCommand(SERVICE_GET_AUDIO_FORMAT, Bundle.EMPTY),
                    Bundle.EMPTY
                )
            }
    ...
    override fun onForegroundServiceStartNotAllowedException() {
        ...
        if (mayThrowForegroundServiceStartNotAllowed()
            ...
            nm.notify(NOTIFY_ID, NotificationCompat.Builder(this, NOTIFY_CHANNEL_ID).apply {
                ...
                setCategory(NotificationCompat.CATEGORY_ERROR)
                setSmallIcon(R.drawable.ic_error)
                setContentTitle(this@MusicDownloaderPlaybackService.getString(R.string.fgs_failed_title))
                setContentText(this@MusicDownloaderPlaybackService.getString(R.string.fgs_failed_text))
                setContentIntent(
                    PendingIntent.getActivity(
                        this@MusicDownloaderPlaybackService,
