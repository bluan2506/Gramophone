...
@Suppress("unused")
class MusicDownloaderExtractorsFactory : ExtractorsFactory {
    companion object {
    ...
    @Synchronized
    fun setConstantBitrateSeekingEnabled(constantBitrateSeekingEnabled: Boolean): MusicDownloaderExtractorsFactory {
        this.constantBitrateSeekingEnabled = constantBitrateSeekingEnabled
        return this
    }

    @Synchronized
    fun setConstantBitrateSeekingAlwaysEnabled(constantBitrateSeekingAlwaysEnabled: Boolean): MusicDownloaderExtractorsFactory {
        this.constantBitrateSeekingAlwaysEnabled = constantBitrateSeekingAlwaysEnabled
        return this
    }

    @Synchronized
    fun setAdtsExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.adtsFlags = flags
        return this
    }

    @Synchronized
    fun setFlacExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.flacFlags = flags
        return this
    }

    @Synchronized
    fun setMatroskaExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.matroskaFlags = flags
        return this
    }

    @Synchronized
    fun setMp4ExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.mp4Flags = flags
        return this
    }

    @Synchronized
    fun setFragmentedMp4ExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.fragmentedMp4Flags = flags
        return this
    }

    @Synchronized
    fun setMp3ExtractorFlags(flags: Int): MusicDownloaderExtractorsFactory {
        this.mp3Flags = flags
        return this
    }
