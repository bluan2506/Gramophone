...
import com.musicdownloader.musicfreeapp825v2.logic.ui.ItemHeightHelper
import com.musicdownloader.musicfreeapp825v2.logic.ui.MyRecyclerView
import com.musicdownloader.musicfreeapp825v2.ui.adapters.AlbumAdapter
import com.musicdownloader.musicfreeapp825v2.ui.adapters.ArtistAdapter
import com.musicdownloader.musicfreeapp825v2.ui.adapters.BaseAdapter
import com.musicdownloader.musicfreeapp825v2.ui.adapters.DateAdapter
import com.musicdownloader.musicfreeapp825v2.ui.adapters.DetailedFolderAdapter
import com.musicdownloader.musicfreeapp825v2.ui.adapters.GenreAdapter
    ...
    private fun createAdapter(savedInstanceState: Bundle?): BaseInterface<*> {
        ...
        return when (id) {
            R.id.songs -> SongAdapter(
                this, qTitle, defaultSortTypeOverride = Sorter.Type.ByAddDateDescending
            )
