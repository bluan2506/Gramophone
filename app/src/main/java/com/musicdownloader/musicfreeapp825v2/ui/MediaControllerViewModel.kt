...
import com.musicdownloader.musicfreeapp825v2.logic.utils.LifecycleCallbackListImpl
...
class MediaControllerViewModel(application: Application) : AndroidViewModel(application),
    ...
    private val context: MusicDownloaderApplication
        get() = getApplication()
    ...
    override fun onStart(owner: LifecycleOwner) {
        val sessionToken =
            SessionToken(context, ComponentName(context, MusicDownloaderPlaybackService::class.java))
